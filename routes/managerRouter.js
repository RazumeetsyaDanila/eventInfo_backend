...
router.post('/completepurchase', checkRole("MANAGER"), managerController.completepurchase);
...
router.get('/upcomingworks', checkRole("MANAGER"), managerController.upcomingworks);
router.post('/completeworks', checkRole("MANAGER"), managerController.completeworks);
